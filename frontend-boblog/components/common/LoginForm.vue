<template>
  <div class="form-wrap">
    <div class="form">
      <div class="form-bg">
        <img src="http://cdn.at-will.cn/login-bg.png" alt="login" />
      </div>
      <div class="form-list">
        <div class="logo">
          <img
            src="https://mbs1.bdstatic.com/searchbox/mappconsole/image/20221026/cd3f97e0-eb66-4d64-a986-3939bb5e09ef.png"
            alt="logo"
          />
        </div>
